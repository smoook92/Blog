		...
		<div class="container-fluid">
			<form action="" id="manage-category">
				...
				<div class="form-group col-md-4">
					<label for="name" class="control-label">Загаловок</label>
				...
				<div class="form-group">
					<label for="" class="control-label">Добавить изображение к содержимому</label>
						<div>
				...
				<div class="form-group">
					<label for="post" class="control-label">Описание</label>
				...
				<center><button class="btn btn-primary btn-block col-md-2">Сохранить</button></center>
			</form>
		</div>
		<script>
	$('.text-jqte').jqte();
